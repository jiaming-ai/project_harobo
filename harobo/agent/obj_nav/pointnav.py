...
class PNAgent():
    def __init__(self, device):
        ...
        model_path ='data/checkpoints/nav_to_pointgoal/latest.pth'
    ...
    def _process_inputs(self, depth, goal_pose, cur_pose):
        ...
        depth = torch.tensor(depth, dtype=torch.float32, device=self.device).unsqueeze(0)
        depth = T.Resize(size=(160,120))(depth).view(1,160,120,1)
        batch = {'robot_head_depth': depth.to(self.device), # Bs, C, H, W
